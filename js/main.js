...
// function setIosGlb(){
//     if (ios == true) {
//         modelViewerImage.setAttribute("src", "img/glb/Thule Motion XT Alpine 629500-Low_v24.glb")
//     }
//     else{
//         modelViewerImage.setAttribute("src", "img/glb/613500_Thule_Vector_Alpine_hp_V1.glb")
//      //   alert('androd')
//     }
// }
// setIosGlb()
...
function sedanAnimation() {
    ...
    if (ios == true) {
       ...
       // modelViewerImage.setAttribute("camera-orbit", "0deg 0deg 0.5m")
    }
}
...
function hatchback() {
    ...
    if (ios == true) {
        modelViewerImage.animationName = animationListValues
       // modelViewerImage.setAttribute("camera-orbit", "0deg 0deg 2m")
    }
}
...
// }
    ...
    function displayItem() {
      previous.disabled = animationList.indexOf(animationListValues) <= 0;
